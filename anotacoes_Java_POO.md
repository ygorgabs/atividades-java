...
FimClasse
```
Neste documento vou colocar o algoritmo da classe e o exercício em Java vai estar em [aqui](https://github.com/ygorgabs/atividades-java/tree/main/Atividades_Java_POO/ExemploPratico)
